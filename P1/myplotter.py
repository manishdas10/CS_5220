...
file1 = 'test/timing-basic.csv'
file2 = 'test/timing-blocked.csv'
file3 = 'test/timing-blas.csv'
...
plt.tight_layout()
plt.savefig('test/timings1_all.jpg',dpi=500)
...
plt.legend(fontsize=20)
plt.tight_layout()
plt.savefig('test/timings2_all.jpg',dpi=500)
